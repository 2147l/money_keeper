<template>
    ...
    <div>
        <ul class="optLabel" v-show="flag1">
            <li @click="changeState11(); drawChart(2)" :class="{ chosenOptLabel: flag11, unchosenOptLabel: !flag11 }">上上周
            </li>
            <li @click="changeState12(); drawChart(1)" :class="{ chosenOptLabel: flag12, unchosenOptLabel: !flag12 }">上周
            </li>
            <li @click="changeState13(); drawChart(0)" :class="{ chosenOptLabel: flag13, unchosenOptLabel: !flag13 }">本周
            </li>
        </ul>
    </div>
    ...
    <div>
        <ul class="optLabel" v-show="flag2">
            ...
            <li @click="changeState23(); drawChart2(0)" :class="{ chosenOptLabel: flag23, unchosenOptLabel: !flag23 }">本月</li>
        </ul>
    </div>
    ...
    <div>
        <ul class="optLabel" v-show="flag3">
            ...
            <li @click="changeState33(); drawChart3(0)" :class="{ chosenOptLabel: flag33, unchosenOptLabel: !flag33 }">今年</li>
        </ul>
    </div>
    <br>
    <br>
    ...
    <!-- 下面这个是支出上上周的内容，标为content11 -->
    <div class="content11" v-show="flag1 && flag11">
        <!-- 这是总览数据，总支出和平均值 -->
        <div class="overview">
            <label for="">总支出：{{ expense }}</label>
            <br>
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    ...
                    <div>
                        <label for="" class="label1">水果 100.0%</label>
                        <label for="" class="label2">40</label>
                    </div>
                    <br>
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">购物 64.4%</label>
                        <label for="" class="label2">69</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
            ...
            <li>
                ...
                <div class="data">
                    ...
                    <div>
                        <label for="" class="label1">餐饮 21.5%</label>
                        <label for="" class="label2">23</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 88px;"></div>
                    <div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如购物 30.8%    12 -->
                    <div>
                        <label for="" class="label1">通讯 14.0%</label>
                        <label for="" class="label2">15</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 47px;"></div>
                    <div>
                    </div>
                </div>
            </li>
        ...
        <ul class="expense">
            ...
            <li>
                ...
                <div class="data">
                    ...
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 110px;"></div>
                    <div>
                    </div>
                </div>
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">零食 100.0%</label>
                        <label for="" class="label2">59</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">美容 44.4%</label>
            ...
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如购物 30.8%    12 -->
                    <div>
                        <label for="" class="label1">通讯 33.3%</label>
                        <label for="" class="label2">90</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 214px;"></div>
                    <div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如购物 30.8%    12 -->
                    <div>
                        <label for="" class="label1">水果 14.8%</label>
                        <label for="" class="label2">40</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 92px;"></div>
                    <div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如购物 30.8%    12 -->
                    <div>
                        <label for="" class="label1">餐饮 7.4%</label>
                        <label for="" class="label2">20</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 46px;"></div>
                    <div>
                    </div>
                </div>
            </li>
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">购物 55.5%</label>
                        <label for="" class="label2">81</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
            ...
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如购物 30.8%    12 -->
                    <div>
                        <label for="" class="label1">餐饮 34.2%</label>
                        <label for="" class="label2">50</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 169px;"></div>
                    <div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如购物 30.8%    12 -->
                    <div>
                        <label for="" class="label1">通讯 10.3%</label>
                        <label for="" class="label2">15</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    ...
                    <div>
                        <label for="" class="label1">美容 44.4%</label>
                        <label for="" class="label2">99</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
            ...
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">餐饮 33.2%</label>
                        <label for="" class="label2">74</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 209px;"></div>
                    <div>
                    </div>
                </div>
            </li>
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">通讯 15.7%</label>
                        <label for="" class="label2">35</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
            ...
            <li>
                ...
                <div class="data">
                    <!-- 下面放的是一些数据信息，如餐饮 69.2%    67 -->
                    <div>
                        <label for="" class="label1">零食 6.7%</label>
                        <label for="" class="label2">15</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
                    <div class="percentBar" style="width: 41px;"></div>
                    <div>
                    </div>
                </div>
            </li>
        ...
        <ul class="expense">
            <li>
                ...
                <div class="data">
                    ...
                    <div>
                        <label for="" class="label1">通讯 29.9%</label>
                        <label for="" class="label2">165</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
            ...
            <li>
                ...
                <div class="data">
                    ...
                    <div>
                        <label for="" class="label1">餐饮 15.6%</label>
                        <label for="" class="label2">86</label>
                    </div>
                    <br>
                    <!-- 下面放的是百分比例条，由于这里不知道怎么调用，这里先固定写，后续再改 -->
                    <!-- 以盒子压缩表示比例条 -->
        ...
        drawChart(flag) {
            ...
            this.$axios.get('http://localhost:8080/bill/getThisWeek', {
                ...
                .then(res => {
                    this.expense = 0
                    for (var i = 0; i < 7; i++) {
                        this.expense += res.data[i].expense
                    }
                    this.expense = Math.round((this.expense) * 100) / 100
                    this.average = (this.expense / 7).toFixed(2)
                    // 指定图表的配置项和数据
                    var option = {
                        xAxis: {
                            type: 'category',
                        ...
                        series: [
                            {
                                data: [-res.data[0].expense, -res.data[1].expense, -res.data[2].expense, -res.data[3].expense, -res.data[4].expense, -res.data[5].expense, -res.data[6].expense],
                                type: 'line',
                                label: {
                                    show: true,
                                    position: 'top',
            ...
            this.$axios.get('http://localhost:8080/bill/getThisMonth', {
                ...
                .then(res => {
                    ...
                    for (var i = 0; i < res.data.length; i++) {
                        this.expense += res.data[i].expense
                        tmpx.push(i + 1)
                        tmpy.push(-res.data[i].expense)
                    }
                    this.expense = Math.round((this.expense) * 100) / 100
                    this.average = (this.expense / res.data.length).toFixed(2)
                    // 指定图表的配置项和数据
                    var option = {
                        xAxis: {
                            type: 'category',
        ...
        drawChart3(flag) {
            ...
            this.$axios.get('http://localhost:8080/bill/getThisYear', {
                ...
                .then(res => {
                    ...
                    this.expense = Math.round((this.expense) * 100) / 100
                    this.average = (this.expense / 12).toFixed(2)
                    // 指定图表的配置项和数据
                    var option = {
                        xAxis: {
                            type: 'category',
